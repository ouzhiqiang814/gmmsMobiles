apiready = function() {
	...
	api.openFrame({
		name : 'GIS_meteorological_information_con',
		url : './GIS_meteorological_information_con.html',
		rect : {
			x : 0,
			y : pos.h+postitle.h,
			w : 'auto',
...
function Selecttype(type,el) {
	...
	var jsfun = 'weatherswitch("'+pla_no[type]+'");';
	api.execScript({
	    frameName: 'GIS_meteorological_information_con',
	    script: jsfun
	});
